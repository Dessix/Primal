...
export class Kernel implements IKernel {
  ...
  public readonly mem: KernelMemory;

  public constructor(kmem: KernelMemory) {
  ...
  public getProcessMemory(pid: ProcessId): ProcessMemory {
    let pmem = this.mem.pmem;
    if (pmem === undefined) {
      this.mem.pmem = pmem = {};
    }
    let pmemi = this.mem.pmem;
    if (pmemi === undefined) {
      pmem[pid] = pmemi = {};
    }
    return pmemi;
  ...
  public deleteProcessMemory(pid: ProcessId): void {
    if (this.mem.pmem !== undefined) {
      delete this.mem.pmem[pid];
    }
  }
