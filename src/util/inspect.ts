...
interface Inspect {
    (obj: any, opts?: Object): string;
    colors: { [colorName: string]: [number, number] };
    styles: { [styleName: string]: string };

}

export const inspect = <Inspect>(function inspect(obj: any, opts: Object = {}): string {
    // default options
    let ctx: any = {
        seen: [],
...
function hasOwn(obj: Object, prop: string | number | symbol): boolean {
...
function arrayToHash<T>(array: T[]): { [strVal: string]: boolean } {
    let hash: { [strVal: string]: boolean } = {};
...
function formatArray(ctx: InspectContext, value: any, recurseTimes: number | null, visibleKeys: { [strVal: string]: boolean }, keys: string[]): string[] {
    let output: string[] = [];
...
function formatValue(ctx: InspectContext, value: any, recurseTimes: number | null) {
...
function formatProperty(ctx: InspectContext, value: any, recurseTimes: number | null, visibleKeys: Object, key: string, array: boolean) {
    let name = "";
    let str = "";
...
function _extend(origin: { [s: string]: any }, add: { [s: string]: any }) {
